...
|[Mesh]({{site.url}}/Pages/Reference/Mesh.html) [MeshQuad]({{site.url}}/Pages/Reference/Default/MeshQuad.html)|A default quad mesh, 2 triangles, 4 verts, from (-.5,-.5,0) to (.5,.5,0) and facing forward on the Z axis (0,0,-1). White vertex colors, and UVs from (0,0) at vertex (-1,-1,0) to (1,1) at vertex (1,1,0).|
