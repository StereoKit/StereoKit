...
namespace StereoKit.Framework
{
	...
	public static class Ease
	{
		...
		/// <param name="t">The easing percentage value, generally 0-1.</param>
		/// <returns>Returns unmodified input.</returns>
		public static float Linear        (float t) => t;

		/// <summary>Quadratic soft start with a hard stop.</summary>
		/// <param name="t">The easing percentage value, generally 0-1.</param>
		/// <returns>Quadratic soft start with a hard stop.</returns>
		...
		/// <param name="t">The easing percentage value, generally 0-1.</param>
		/// <returns>Quadratic fast start with a soft stop.</returns>
		...
		/// <param name="t">The easing percentage value, generally 0-1.</param>
		/// <returns>Soft start with a hard stop, overshoots its destination a
		/// bit before arriving at it.</returns>
		...
		/// <param name="t">The easing percentage value, generally 0-1.</param>
		/// <returns>Fast start with a soft stop, backs off a bit before moving
		/// to its destination.</returns>
		...
		/// <param name="t">The easing percentage value, generally 0-1.</param>
		/// <returns>Smooth start, fast middle, and smooth stop. Overshoots on
		/// both the start and the end.</returns>
