namespace StereoKit
{
	...
	public static class Device
	{
		...
		public static bool ValidBlend(DisplayBlend blend)
			=> NB.Bool(NativeAPI.device_display_valid_blend(blend));
		...
		public static string Name => NativeAPI.device_get_name();
		...
		/// </summary>
		public static string Runtime => NativeAPI.device_get_runtime();
		/// <summary>The reported name of the GPU, this will differ between D3D
		/// and GL.</summary>
		public static string GPU => NativeAPI.device_get_gpu();
		...
		public static bool HasEyeGaze => NB.Bool(NativeAPI.device_has_eye_gaze());
		...
		public static bool HasHandTracking => NB.Bool(NativeAPI.device_has_hand_tracking());
	}
}
