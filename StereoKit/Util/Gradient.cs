...
namespace StereoKit
{
    ...
    {
        /// <summary>The color for this item, can be whatever color space you
        /// want, as long as it's consistent with the other keys.</summary>
        public Color color;
    ...
    /// stored as float colors, so this'll be a high accuracy blend!</summary>
    public class Gradient
    {
        ...
        /// <param name="color">Any color you like!</param>
        ...
        /// smaller or larger than the gradient's position range, then the color will
        /// be clamped to the color at the beginning or end of the gradient!</returns>
        public Color   Get  (float at) => NativeAPI.gradient_get  (_inst, at);
        /// <summary>Samples the gradient's color at the given position, and converts
        ...
        /// larger or smaller values for your color key's positions, it'll be
        /// in that range!</param>
        /// <returns>The interpolated 32 bit color at the given position. If 'at' is
        /// smaller or larger than the gradient's position range, then the color will
        /// be clamped to the color at the beginning or end of the gradient!</returns>
