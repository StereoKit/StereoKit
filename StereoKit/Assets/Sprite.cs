...
namespace StereoKit
{
    ...
    /// why you might wish to put a sprite in one atlas or another, so you can apply different</summary>
    public class Sprite
    {
        internal IntPtr _inst;

        /// <summary>The aspect ratio of the sprite! This is width/height. You may also
        /// be interested in the NormalizedDimensions property, which are normalized to
        /// the 0-1 range.</summary>
        ...
        {
            if (_inst != IntPtr.Zero)
                NativeAPI.sprite_release(_inst);
        }
