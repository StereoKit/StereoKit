...
namespace StereoKit
{
    ...
    public class Solid
    {
        ...
        /// want to prevent physics from influencing this solid!</summary>
        public bool Enabled { set{ SetEnabled(value); } }

        /// <summary>This adds a sphere to this solid's physical shape! This is in addition
        /// to any other shapes you've added to this solid.</summary>
        ...
        /// shape! This is in addition to any other shapes you've added to this solid.</summary>
        /// <param name="diameter">The diameter of the cylinder, as well as the capsule ends, in meters.</param>
        ...
        /// <summary>Same as Enabled. Is the Solid enabled in the physics simulation? Set this to false if you 
        /// want to prevent physics from influencing this solid!</summary>
        /// <param name="enabled">False to disable physics on this object, true to enable it.</param>
        public void SetEnabled(bool enabled)
        {
            NativeAPI.solid_set_enabled(_inst, enabled?1:0);
        }
        /// <summary>This moves the Solid from its current location through space to the new location
        ...
        /// <summary>Retreives the current pose of the Solid from the physics simulation.</summary>
