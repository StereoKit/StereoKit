...
namespace StereoKit
{
    public class Renderer
    {
        ...
        {
            NativeAPI.render_add_mesh_tr(mesh._meshInst, material._materialInst, transform._transformInst);
        }
        public static void Add(Mesh mesh, Material material, Matrix transform)
        {
            NativeAPI.render_add_mesh(mesh._meshInst, material._materialInst, ref transform);
        }
        public static void Add(Model model, Transform transform)
        {
            NativeAPI.render_add_model_tr(model._modelInst, transform._transformInst);
        }
        public static void Add(Model model, Matrix transform)
        {
            NativeAPI.render_add_model(model._modelInst, ref transform);
        }
