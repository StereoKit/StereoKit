...
namespace StereoKit
{
	internal static class NativeAPI
	{
		...
		[DllImport(dll, CharSet = cSet, CallingConvention = call)] public static extern bool platform_keyboard_switch(TextContext keyboard_type, string[] keyboard_layout, int layouts_num);
