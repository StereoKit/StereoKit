...
namespace StereoKit
{
	internal static class NativeAPI
	{
		...
		[DllImport(dll, CharSet = cSet, CallingConvention = call)] public static extern BtnState input_key          (Key key, uint code = 0);
		...
		[DllImport(dll, CharSet = cSet, CallingConvention = call)] public static extern void     input_key_inject_press  (Key key, uint code = 0);
		[DllImport(dll, CharSet = cSet, CallingConvention = call)] public static extern void     input_key_inject_release(Key key, uint code = 0);
