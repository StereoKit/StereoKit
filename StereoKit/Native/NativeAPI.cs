...
namespace StereoKit
{
	internal static class NativeAPI
	{
		...
		[DllImport(dll, CharSet = cSet, CallingConvention = call)] public static extern int        sk_init_from(IntPtr window_handle, string app_name, Runtime preferred_runtime, int fallback = 1);
