...
namespace StereoKit
{
    internal static class NativeAPI
    {
        ...
        [DllImport(NativeLib.DllName, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)] public static extern bool ui_input       (string id,   StringBuilder buffer, int buffer_size);
