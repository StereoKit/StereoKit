...
namespace StereoKit
{
	internal static class NativeAPI
	{
		...
		[DllImport(dll, CharSet = cSet, CallingConvention = call)] public static extern void ui_push_surface          (Pose surface_pose, Vec3 surface_scale, Vec3 layout_start, Vec2 layout_dimensions);
		...
		[DllImport(dll, CharSet = CharSet.Unicode, CallingConvention = call)] public static extern bool ui_handle_begin_sc_16(string text, ref Pose movement, ref Vec3 scale, Bounds handle, int draw, UIMove move_type);
