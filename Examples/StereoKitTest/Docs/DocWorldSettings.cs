...
class DocWorldSettings : ITest
{
	...
	{
		/// :CodeSample: World WorldRefresh World.Occlusion World.OcclusionCapabilities World.RefreshType World.RefreshInterval World.RefreshRadius
	...
	public void Shutdown() => World.Occlusion = OcclusionCaps.None;
	public void Step() { }
}
