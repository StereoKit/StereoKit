...
class DemoUI : ITest
{
	...
	float clipSlider;
	int   clipOption = 1;
	Material volumeMat = Default.MaterialUI.Copy();
	...
	public void Initialize() {
		volumeMat.Transparency = Transparency.Blend;
		volumeMat[MatParamName.ColorTint] = new Color(1,1,1,0.5f);
		volumeMat.DepthWrite = false;
		volumeMat.QueueOffset = -1;
		...
		Tests.Screenshot(600, 600, "InteractVolume.jpg", new Vec3(-0.149f, 0.377f, -0.268f), new Vec3(0.386f, -0.307f, -0.764f));
	}
