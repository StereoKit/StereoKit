...
void demo_anchors_update() {
	...
	if (!interactor_is_interacting(interactor_source_any) && input_hand(handed_right)->pinch_state & button_state_just_active || input_key(key_space) & button_state_just_active) {
