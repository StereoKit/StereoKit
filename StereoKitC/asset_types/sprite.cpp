...
void sprite_draw(sprite_t sprite, matrix transform, pivot_ pivot_position, color32 color, render_layer_ layer) {
	sprite_drawer_add_at(sprite, transform, pivot_position, color, layer);
}
