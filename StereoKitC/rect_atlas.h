...
rect_atlas_t rect_atlas_create(recti_t source_size) {
	rect_atlas_t result = {};
	result.free_space.add(source_size);
	result.w = source_size.w;
	result.h = source_size.h;
	return result;
}
...
inline int32_t recti_area(const recti_t &r) {
	return r.w * r.h;
}

///////////////////////////////////////////

inline int32_t rect_atlas_free_space(const rect_atlas_t *atlas) {
	return atlas->free_space.each_sum(recti_area);
}

///////////////////////////////////////////

inline int32_t rect_atlas_used_space(const rect_atlas_t *atlas) {
	return atlas->packed.each_sum(recti_area);
}
