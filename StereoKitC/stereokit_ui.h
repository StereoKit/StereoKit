...
SK_API bool32_t ui_hslider_16     (const char16_t *id, sk_ref(float) value, float min, float max, float step, float width sk_default(0), ui_confirm_ confirm_method sk_default(ui_confirm_push));
