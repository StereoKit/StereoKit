...
typedef enum ui_move_ {
	...
	ui_move_rot         = 1 << 1,
	ui_move_scale       = 1 << 2,
	ui_move_face_user   = 1 << 3 | ui_move_pos,
...
SK_API void     ui_push_surface          (pose_t surface_pose, float surface_scale sk_default(1), vec3 layout_start sk_default(vec3_zero), vec2 layout_dimensions sk_default(vec2_zero));
