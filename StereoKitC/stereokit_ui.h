...
SK_API bool32_t ui_input          (const char     *id, char     *buffer, int32_t buffer_size, vec2 size sk_default(vec2_zero), bool useNativeKeyboard sk_default(1), keyboard_input_type_ type sk_default(keyboard_input_type_::text));
SK_API bool32_t ui_input_16       (const char16_t *id, char16_t *buffer, int32_t buffer_size, vec2 size sk_default(vec2_zero), bool useNativeKeyboard sk_default(1), keyboard_input_type_ type sk_default(keyboard_input_type_::text));
