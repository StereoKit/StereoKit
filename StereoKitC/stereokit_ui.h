...
SK_API bool32_t ui_button_img_color(const char* text, sprite_t image, ui_btn_layout_ image_layout, color128 image_tint);
...
SK_API bool32_t ui_button_img_sz_color(const char* text, sprite_t image, ui_btn_layout_ image_layout, vec2 size, color128 image_tint);
...
SK_API bool32_t ui_button_img_at_color(const char* text, sprite_t image, ui_btn_layout_ image_layout, vec3 window_relative_pos, vec2 size, color128 image_tint);
