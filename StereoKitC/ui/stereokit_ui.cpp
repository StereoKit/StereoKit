...
bool32_t ui_hslider_at_f64   (const char     *id_text, double &value, double min, double max, double step, vec3 window_relative_pos, vec2 size, ui_confirm_ confirm_method, ui_notify_ notify_on) { float tmp = value; bool32_t result = ui_slider_at_g<char    , float>(false, id_text, tmp, min, max, step, window_relative_pos, size, confirm_method, notify_on); value = tmp; return result;}
bool32_t ui_hslider_at_f64   (const char16_t *id_text, double &value, double min, double max, double step, vec3 window_relative_pos, vec2 size, ui_confirm_ confirm_method, ui_notify_ notify_on) { float tmp = value; bool32_t result = ui_slider_at_g<char16_t, float>(false, id_text, tmp, min, max, step, window_relative_pos, size, confirm_method, notify_on); value = tmp; return result;}
...
bool32_t ui_vslider_at_f64   (const char     *id_text, double &value, double min, double max, double step, vec3 window_relative_pos, vec2 size, ui_confirm_ confirm_method, ui_notify_ notify_on) { float tmp = value; bool32_t result = ui_slider_at_g<char    , float>(true, id_text, tmp, min, max, step, window_relative_pos, size, confirm_method, notify_on); value = tmp; return result;}
bool32_t ui_vslider_at_f64   (const char16_t *id_text, double &value, double min, double max, double step, vec3 window_relative_pos, vec2 size, ui_confirm_ confirm_method, ui_notify_ notify_on) { float tmp = value; bool32_t result = ui_slider_at_g<char16_t, float>(true, id_text, tmp, min, max, step, window_relative_pos, size, confirm_method, notify_on); value = tmp; return result;}
