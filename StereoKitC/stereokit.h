...
SK_API void                  render_screenshot_capture(void (*render_on_screenshot_callback)(uint8_t* out_arr_data, int32_t data_length), vec3 from_viewpt, vec3 at, int32_t width, int32_t height, float field_of_view_degrees);
SK_API void                  render_screenshot_viewpoint(void (*render_on_screenshot_callback)(uint8_t* out_arr_data, int32_t data_length), const sk_ref(matrix) camera, const sk_ref(matrix) projection, int32_t width, int32_t height, render_layer_ layer_filter sk_default(render_layer_all), render_clear_ clear sk_default(render_clear_all));
