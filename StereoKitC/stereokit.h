...
SK_API button_state_         input_key               (key_ key, uint8_t code sk_default(key_none));
SK_API void                  input_key_inject_press  (key_ key, uint8_t code sk_default(key_none));
SK_API void                  input_key_inject_release(key_ key, uint8_t code sk_default(key_none));
