...
SK_API        vec3     color_to_hsv   (color128 srgb_gamma_correct);
SK_API        color128 color_lab      (float l, float a, float b, float transparency);
SK_API        vec3     color_to_lab   (color128 srgb_linear);
SK_API        color128 color_oklab    (float lightness, float a, float b, float transparency);
SK_API        vec3     color_to_oklab (color128 srgb_linear);
SK_API        color128 color_okhsv    (float hue, float saturation, float value, float transparency);
SK_API        vec3     color_to_okhsv (color128 srgb_gamma_correct);
