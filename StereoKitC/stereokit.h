...
SK_API sprite_t    sprite_create     (tex_t    sprite, sprite_type_ type sk_default(sprite_type_atlased), const char* atlas_id sk_default("default"), material_t material sk_default(nullptr));
SK_API sprite_t    sprite_create_file(const char* filename_utf8, sprite_type_ type sk_default(sprite_type_atlased), const char* atlas_id sk_default("default"), material_t material sk_default(nullptr));
