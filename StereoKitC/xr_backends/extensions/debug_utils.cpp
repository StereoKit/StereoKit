...
xr_system_ xr_ext_debug_utils_pre_session(void*, XrBaseHeader*);
...
void xr_ext_debug_utils_register() {
	...
	sys.evt_pre_session = { xr_ext_debug_utils_pre_session };
	sys.evt_initialize  = { xr_ext_debug_utils_initialize  };
	sys.evt_shutdown    = { xr_ext_debug_utils_shutdown    };
