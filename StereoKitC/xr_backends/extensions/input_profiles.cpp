...
void xr_profile_bd_controller_interaction_register() {
	...
	sys.evt_initialize = { [](void*) {
		...
		profile3_l.binding[profile3_l.binding_ct++]={ xra_type_haptic, input_haptic_l_controller, "haptic"           };
		...
		profile3_r.binding[profile3_r.binding_ct++]={ xra_type_haptic, input_haptic_r_controller, "haptic"           };
		...
		profile4_l.binding[profile4_l.binding_ct++]={ xra_type_haptic, input_haptic_l_controller, "haptic"           };
		...
		profile4_r.binding[profile4_r.binding_ct++]={ xra_type_haptic, input_haptic_r_controller, "haptic"           };
