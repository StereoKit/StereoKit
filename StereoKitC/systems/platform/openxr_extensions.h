...
#define FOR_EACH_PLATFORM_FUNCTION(_) _(xrGetD3D11GraphicsRequirementsKHR)
#elif defined(XR_USE_GRAPHICS_API_OPENGL)
#define FOR_EACH_PLATFORM_FUNCTION(_) _(xrGetOpenGLGraphicsRequirementsKHR)
#elif defined(XR_USE_GRAPHICS_API_OPENGL_ES)
#define FOR_EACH_PLATFORM_FUNCTION(_) _(xrGetOpenGLESGraphicsRequirementsKHR)
#elif defined(XR_USE_GRAPHICS_API_VULKAN)
#define FOR_EACH_PLATFORM_FUNCTION(_) _(xrGetVulkanGraphicsRequirementsKHR)
#endif
